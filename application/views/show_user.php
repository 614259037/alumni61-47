      ...
      <div class="col-md-7">
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="ตำแหน่งงาน" name="joblv" value="<?php echo $show['cname'] ?>" readonly>
          </div>
        </div>
        <!--ตำแหน่งงาน-->
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="ชื่อบริษัท" name="jobname" value="<?php echo $show['cname'] ?>" readonly>
          </div>
        </div>
        <!--ชื่อบริษัท-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12 " align="left">
            ...
            <textarea name="jobaddress" id="form-control" rows="10" cols="60" readonly><?php echo $show['cname'] ?></textarea>
          </div>
        ...
        <div class="form-group col-md-5" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            <label for="Input2" style="margin-bottom: 0">จังหวัด</label>
            <input type="text" class="form-control" id="Input2" name="jobprov" value="<?php echo $show['cname'] ?>" readonly>
        ...
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="เบอร์โทรศัพท์บ้าน" name="hphone" value="<?php echo $show['cname'] ?>" readonly>
          </div>
        </div>
        <!--เบอร์โทรศัพท์-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="email" class="form-control" id="form-control" placeholder="อีเมล์" name="email" value="<?php echo $show['cname'] ?>" readonly>
          </div>
        </div>
        <!--อีเมล-->
        <div class="form-group col-md-8" style="margin-bottom: 0">
          <div class="form-group col-md-12" align="left">
            ...
            <input type="text" class="form-control" id="form-control" placeholder="facebook" name="facebook" value="<?php echo $show['cname'] ?>" readonly>
          </div>
        </div>
        <!--facebook-->
